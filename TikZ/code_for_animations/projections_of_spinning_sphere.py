# Name: Jasper
# Date: 2024
# Title: projections_of_spinning_sphere
# Credit:
#   I used code from https://tex.stackexchange.com/a/726815/319072 to overcome a barrier with the projections.
...
({0.5*cos(\Vi)*cos(0)},{0.5*cos(\Vi)*sin(0)},{0.5*sin(\Vi)})
 foreach \t in {20,40,...,340}{ 
-- ({0.5*cos(\Vi)*cos(\t)},{0.5*cos(\Vi)*sin(\t)},{0.5*sin(\Vi)})
} -- cycle;
\draw[tdplot_rotated_coords]
({0.5*cos(0)*cos(\Vi)},{0.5*cos(0)*sin(\Vi)},{0.5*sin(0)})
 foreach \t in {20,40,...,340}{ 
-- ({0.5*cos(\t)*cos(\Vi)},{0.5*cos(\t)*sin(\Vi)},{0.5*sin(\t)})
} -- cycle;
}
