...
# Partial credit (for the formulae, not the code): https://www.researchgate.net/publication/376028984_Visualizing_atomic_orbitals_of_an_electron_by_Latex
...
\tdplotsetpolarplotrange{0}{360}{0}{360}
\tdplotsphericalsurfaceplot[parametricfill]{72}{36}%
{sqrt(15)/(4*sqrt(pi))*(sin(\tdplottheta))^2*cos(2*\tdplotphi)}{black}{\tdplotphi}%
{\path[color=black,thick,->] (0,0,0)
-- (1,0,0) node[anchor=north east]{};}%
{\path[color=black,thick,->] (0,0,0)
-- (0,1,0) node[anchor=north west]{};}%
...
\tdplotsetpolarplotrange{0}{360}{0}{360}
\tdplotsphericalsurfaceplot[parametricfill]{72}{36}%
{sqrt(35)/(4*sqrt(2*pi))*(sin(\tdplottheta))^3*cos(3*\tdplotphi)}{black}{\tdplotphi}%
{\path[color=black,thick,->] (0,0,0)
-- (1,0,0) node[anchor=north east]{};}%
{\path[color=black,thick,->] (0,0,0)
-- (0,1,0) node[anchor=north west]{};}%
...
def main():
    """
    Purpose:
        Makes an animation of four solutions to the Schrodinger Equation, each spinning in a circle.
    Parameters:
        No parameters.
    Return:
        Void.
